...
-- The theme for the exercise is that of a workshop. Create a database to store information and tables related to this workshop.
...
-- won't be used in any other device. Make a table called parts that reflects the information listed 
-- above. Table parts should have the following columns that meet the following specifications:
