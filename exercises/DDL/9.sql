...
-- At that point, we're going to need a moons table in our extrasolar database. For this exercise, your 
-- task is to add that table to the database. The table should include the following data:
...
-- semi_major_axis: the average distance in kilometers from the planet when a moon is farthest from 
-- its corresponding planet. This field must be a number greater than 0, but is not required; 
